                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>You can update your medical history either by <b>uploading a file</b> or by <b>writing</b></p>
                                    <form role="form">
                                        <div class="form-group">
                                            <label path="med-file">Upload file:</label>
                                            <input id="med-file" class="form-control" type="file" name="med-file" path="med-file"/>
                                        </div>
                                        <div class="form-group">
                                            <label path="med-text">Write:</label>
                                            <textarea id="med-text" class="form-control" type="text" name="med-text" rows="7" ></textarea>
                                        </div>
                                        <div class="text-center">
                                            <input name="med-submit" path="med-submit" id="med-submit" class="btn btn-primary" type="submit" value="Submit"/>
                                        </div>
                                    </form>
                                </div>
            ...
            <div class="container" id="symptomChecker">
                <div class="row" style="justify-content: center; display: flex;">
                    <div class="col-md-6 bg-light p-4 rounded mt-5">
                        ...
                        <div class="progress mb-3 rounded" style="height: 40px; justify-content: center; align-content: center;">
                                ...
                                <div class="btn-group btn-group-toggle" data-toggle="buttons"
                                    ...
                                    <ul>
                                        <li class="btn btn-light active btn-lg-01" style="margin-right: 40px;">
                                            <input type="radio" name="gender" id="male" autocomplete="off" value="male" checked class="gender">
                                            <img src="img/male-solid.svg" alt="Male">
                                        </li>

                                        <li class="btn btn-light btn-lg-01">
                                            <input type="radio" name="gender" id="female" autocomplete="off" value="female" class="gender">
                        ...
                        <div id="tab-3">
                            ...
                            <div class="radio">
                                <label class="font-weight-bolder"><input class="geo" type="radio" name="optradio" value="p_13"><span
                                        style="margin-left: 30px;">North
                                        America without Mexico</span></label>
                            </div>
                            <div class="radio">
                                <label class="font-weight-bolder"><input class="geo" type="radio" name="optradio" value="p_14"><span
                            ...
                            <div class="radio">
                                <label class="font-weight-bolder"><input class="geo" type="radio" name="optradio" value="p_16"><span
                                        style="margin-left: 30px;">Northern Africa</span></label>
                            </div>
                            <div class="radio">
                                <label class="font-weight-bolder"><input class="geo" type="radio" name="optradio" value="p_17"><span
                                        style="margin-left: 30px;">Central
                                        Africa</span></label>
                            </div>
                            <div class="radio">
                                <label class="font-weight-bolder"><input class="geo" type="radio" name="optradio" value="p_18"><span
                                        style="margin-left: 30px;">Southern Africa</span></label>
                            </div>
                            <div class="radio">
                                <label class="font-weight-bolder"><input class="geo" type="radio" name="optradio" value="p_19"><span
                                        style="margin-left: 30px;">Australia and Oceania</span></label>
                            </div>
                            <div class="radio">
                                <label class="font-weight-bolder"><input class="geo" type="radio" name="optradio" value="p_20"><span
                                        style="margin-left: 30px;">Russia,
                                        Kazakhstan and Mongolia</span></label>
                            </div>
                            <div class="radio">
                                <label class="font-weight-bolder"><input class="geo" type="radio" name="optradio" value="p_21"><span
