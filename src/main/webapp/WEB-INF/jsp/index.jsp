<%-- 
    Document   : index
    Created on : Apr 17, 2020, 9:18:15 PM
    Author     : Natasa
--%>
        ...
        <div class="navbar-collapse collapse">
            <div class="menu">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/">Home</a>
                    </li>
    ...
    <div class="row">
        <div class="slider">
            <div class="img-responsive">
                <ul class="bxslider">
                    <li><img src="${pageContext.request.contextPath}/img/logo.jpg" style="padding-left: 28%;" alt=""/>
                    </li>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="text-center">
                <h2>See the first available doctor</h2>
                <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="0.4s">
                    ...
                    <div class="ficon">
                        <a href="${pageContext.request.contextPath}/registerForm" class="btn btn-default" role="button"><b>
                            Get Started</b></a>
                    </div>
                </div>
